...
namespace AuroraLib.Compression.Formats.HudsonSoft
{
    /// <summary>
    /// Run-Length Encoding algorithm used by Hudson Soft.
    /// </summary>
    public sealed class RLHudson : ICompressionAlgorithm, IProvidesDecompressedSize
    {
        ...
        public static bool IsMatchStatic(Stream stream, ReadOnlySpan<char> fileNameAndExtension = default)
            => stream.Position + 0x6 < stream.Length && stream.Peek(s => s.ReadInt32(Endian.Big) != 0 && s.ReadInt32(Endian.Big) == Identifier);
