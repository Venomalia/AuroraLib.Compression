...
namespace AuroraLib.Compression.Formats.Konami
{
    /// <summary>
    ...
    public sealed class MDF0 : ICompressionAlgorithm, IProvidesDecompressedSize
    {
        ...
        public static bool IsMatchStatic(Stream stream, ReadOnlySpan<char> fileNameAndExtension = default)
            => stream.Position + 0x10 < stream.Length && stream.Peek(s => s.Match(_identifier) && s.ReadUInt32() != 0 && ZLib.IsMatchStatic(s));
        ...
        public void Compress(ReadOnlySpan<byte> source, Stream destination, CompressionSettings settings = default)
        {
            ...
            zLib.Compress(source, destination, settings);
        }
    }
}
